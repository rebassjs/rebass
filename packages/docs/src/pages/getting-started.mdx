...
By default Rebass components have no default theme. To use the Rebass default theme, install it as well, and wrap your application with a `ThemeProvider`.
...
Define custom variants in your own theme or use the defaults in the Rebass preset theme.
