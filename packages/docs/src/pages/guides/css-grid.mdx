...
By using the `sx` prop, CSS properties such as `gridGap` will use values from you theme object.
...
<Box
  ...
  <Heading bg='muted'>Hello</Heading>
  <Box color='background' bg='primary'>CSS Grid</Box>
</Box>
```
