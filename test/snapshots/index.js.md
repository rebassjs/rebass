...
> Snapshot 1
    ...
    <button
      className="sc-gqPbQI hfuGLd sc-cLQEGU hCkCHQ sc-VigVT jLLmeh sc-gqjmRU hjLbka sc-gzVnrw SufaX sc-bZQynM eTqNda"
      is={null}
    >
      ×
    </button>
...
> Snapshot 1
    ...
    <select
      className="sc-csuQGl etIGXu sc-gipzik exVYnT"
      is={null}
    />
...
> Snapshot 1
    ...
    <input
      className="sc-eqIVtm jLrxgY sc-dVhcbM eMYJAu"
      is={null}
      type="range"
    />
